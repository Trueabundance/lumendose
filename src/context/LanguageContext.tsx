...
export const translations: Translations = {
    ...
    es: {
        ...
        header_premium_status: "Premium",
        section_title_impact: "Impacto Cerebral",
        section_subtitle_impact: "Modelo educativo de efectos del alcohol.",
        label_total_alcohol: "Alcohol Total",
        section_title_control: "Consumo",
        button_log_drink: "Registrar",
        button_scan_drink: "Escanear",
        section_title_log: "Registro Actual",
        log_empty: "Sin bebidas registradas.",
        modal_title: "Registrar Bebida",
        modal_drink_type: "Tipo de Bebida",
        modal_volume: "Volumen (ml)",
        modal_abv: "ABV (%)",
        modal_add_button: "Añadir",
        ai_coach_title: "Consejo de IA",
        ai_coach_generating: "Generando consejo...",
        camera_modal_title: "Escanear Etiqueta",
        camera_modal_prompt: "Apunta a la etiqueta de la bebida.",
        camera_modal_capture: "Capturar",
        camera_modal_analyzing: "Analizando...",
        scan_error_alert: "Error al escanear. Verifique conexión.",
        manage_quick_adds: "Gestionar Rápidos",
        no_custom_quick_adds: "Sin atajos personalizados.",
        achievements_title: "Logros",
        // Add more keys as needed, falling back to EN for now
    },
    fr: {
        app_title: "LumenDose",
        header_premium_button: "Devenir Premium",
        header_premium_status: "Premium",
        section_title_impact: "Impact Cérébral",
        section_subtitle_impact: "Modèle éducatif des effets de l'alcool.",
        label_total_alcohol: "Alcool Total",
        section_title_control: "Consommation",
        button_log_drink: "Enregistrer",
        button_scan_drink: "Scanner",
        section_title_log: "Journal de Session",
        log_empty: "Aucune boisson enregistrée.",
        modal_title: "Enregistrer une Boisson",
        modal_drink_type: "Type de Boisson",
        modal_volume: "Volume (ml)",
        modal_abv: "ABV (%)",
        modal_add_button: "Ajouter",
        ai_coach_title: "Conseil IA",
        ai_coach_generating: "Génération...",
        camera_modal_title: "Scanner l'étiquette",
        camera_modal_prompt: "Pointez vers l'étiquette.",
        camera_modal_capture: "Capturer",
        camera_modal_analyzing: "Analyse...",
        scan_error_alert: "Erreur de scan. Vérifiez la connexion.",
        manage_quick_adds: "Gérer les Raccourcis",
        no_custom_quick_adds: "Pas de raccourcis personnalisés.",
